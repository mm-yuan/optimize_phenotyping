function plotFeature(Template, space, best_dir, score, savepath, fname, txt)
...
set(cb,'FontSize',8);
title(['Facial Trait Score ' num2str(score) txt]);
...
print(v.Figure,'-dpng','-r300',[savepath '/FacialFeatures' fname '_Score' num2str(score) '.png']); 
% exportgraphics
